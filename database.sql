...
INSERT INTO `Admin` VALUES (
  ...
  'Jawad',
  'Kabir',
  'jkabir.bscs21seecs@seecs.edu.pk',
  'jawad'
),
(
  2,
  'Uneeb',
  'Aftab',
  'muneeb.bscs21seecs@seecs.edu.pk',
  'uneeb'
),
(
  3,
  'Ahad',
  'Sajjad',
  'asajjad.bscs21seecs@seecs.edu.pk',
  'ahad');
...
CREATE TRIGGER `update_project_collected`
...
INSERT INTO `Project` VALUES (1,'Food Distribution','Providing food to needy families during the pandemic',1,10000,0),(2,'Education for Orphans','Providing education to orphans in the village',2,5000,0),(3,'Cancer Treatment','Providing cancer treatment to patients who cannot afford it',3,7500,0),(4,'Medical Camp','Providing medical treatment to people in remote areas',4,12000,0),(5,'Eye Surgery','Performing eye surgeries for patients with cataracts',5,9000,0);
...
-- Dump completed on 2023-05-10 14:15:08
